 ...
 */
public class ClassilistNodePlugin extends Plugin {
    // The shared instance.
    private static ClassilistNodePlugin plugin;

    /**
     * The constructor.
     */
    public ClassilistNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ClassilistNodePlugin getDefault() {
        return plugin;
    }
